...
<html lang="en">
    <head>
        <!-- 
            ...
            Auteur : Kathleen Lu
            Date : 04.06.2023
            Description : La page de catalogue des produits tonifiants du site de Peach Youth contenant :
                            - une barre de filtres pour choisir une catégorie du catalogue
                            - une section pour les toners pour le visage
        -->
        <meta charset="UTF-8">
        ...
        <title>Toners | Peach Youth</title>
    </head>
    <body>
        <nav id="mainNav">
        ...
        <header id="simpleHeader">
            <div id="catalogHero">
                <p id="catalogNav"><a href="catalogAll.html">Catalog</a> / <a href="#filter">Toners</a></p>
                <section id="catalogHeroText">
                    <h1>Prep your skin with toners</h1>
                    <p class="heroParagraph">Toners are typically used after cleansing the face and before applying other skincare products such as moisturizers or serums.</p>
                </section>
            </div>
        </header>
        ...
        <main>
            <nav id="filter">
                <ul>
                    ...
                    <li><a href="#" class="currentFilter">Toners</a></li>
            ...
            <section id="toners" class="category lastContainer">
                <h2>Toners</h2>
                <div class="container">
                    <div class="product">
